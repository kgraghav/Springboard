...
Host: localhost
Database: country_club
Generation Time: Aug 03, 2024 at 06:12 AM
Generated by: phpMyAdmin 4.0.10deb1 / MySQL 5.5.43-0ubuntu0.14.04.1
SQL query: SELECT DISTINCT f.name as fac_name, m.firstname AS firstname, m.surname AS surname, 
...
ON b.memid = m.memid 
HAVING cost>30 LIMIT 0, 1000 ;
Rows: 2

 This table does not contain a unique column. Grid edit, checkbox, Edit, Copy and Delete features are not available.
fac_name	firstname	surname	cost	
